...
import BgImage from './assets/Img/backgroundImage.svg'
              ...
              <div className="card card-plain mt-8">
                ...
                <div className="card-body">
                  <form role="form" onSubmit={handleSubmit} >
                    ...
                    <div className="text-center">
                      <button type="button" className="btn text-redpayflip text-white w-100 mt-4 mb-0" disabled={!formValidation()} >Sign in</button>
                    </div>
                  </form>
                </div>
                <div className="card-footer text-center pt-0 px-lg-2 px-1">
                  <p className="mb-4 text-sm mx-auto">
                    ...
                    <a href="javascript:;" className="text-bluepayflip font-weight-bold">Sign up</a>
                  </p>
                </div>
              </div>
            </div>
