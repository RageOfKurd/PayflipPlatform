  ...
  >
    ...
    >
      <ul  className="navbar-nav">
        ...
        <li  className="nav-item">
          <a  className="nav-link" href="../pages/employer-profile.html">
            <div
               className="
                icon icon-shape icon-sm
                shadow
    ...
    <div  className="sidenav-footer mx-3">
      ...
      >
        <div
          ...
          style={{backgroundImage:`url(${whiteCurved})`}}
        ></div>
        ...
        <div  className="row">
          <div  className="col-12">
            ...
            <div  className="card mb-4">
              ...
              <div  className="card-header row-md-2 col-md-0">
                <h6>Employees table</h6>
              
              </div>
              <div  className="card-header row-md-1 col-md-0">
                <button  className="btn btn-link text-secondary">
                  <i  className="fa fa-user-plus text-xs"  aria-hidden="true"></i>
                  </button>
              </div>
            ...
            <div  className="col-12">
              <div  className="card mb-4">
                <div  className="card-header pb-0">
                  <h6>Benefits for this company</h6>
                </div>
                <div  className="card-body px-0 pt-0 pb-2">
                  <div  className="table-responsive p-0">
                    <table
                    ...
                    >
                      ...
                      <tbody>
                        <tr>
                          <td>
                            <div  className="d-flex px-2">
                              <a href="../pages/admin-company-overwiev.html">
                                <img
                                  src="../assets/img/small-logos/logo-spotify.svg"
                          ...
                          <td>
                            <span  className="text-xs font-weight-bold">Sweden</span>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <span  className="text-xs font-weight-bold">US</span>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <span  className="text-xs font-weight-bold">Germany</span>
                          </td>
