                                    ...
                                    <div className="card z-index-0">
                                        <div className="extrashadow">
                                            <div className="card-header text-center pt-4">
                                                <h3 className="text-info">Register an Employee</h3>
                                            </div>
                                            <div className="card-body">
                                                <form className="formtext" onSubmit={submitHandling}>
                                                    <div className="mb-3">
                                                        <input type="text" className="form-control" value={employeeName} onChange={(answer) => { setemployeeName(answer.target.value) }} placeholder="Employee Name"
                                                    ...
                                                    <p hidden="true" id="existerror" style={{ color: "red", fontWeight: "bold", fontSize: "14px" }}>Employee Already Exists!</p>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
