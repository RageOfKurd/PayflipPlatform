...
export const AdminEmployersPage = () => {
  ...
  const deleteCompany = (id) => {
    ...
    try {
      axios.delete(`http://localhost:7000/employer/${id.target.value}`, { headers: headers })
                                    ...
                                    <td>
                                      <div className="d-flex px-3">
                                        <div className="my-auto">
                                          <h6 className="mb-0 text-sm">{employer.name}</h6>
                                        </div>
                                      </div>
                                    </td>
                                    <td>
                                      <p className="text-sm font-weight-bold mb-0">{employer.user.email}</p>
                                    </td>
                                    <td>
                                      <span className="text-xs font-weight-bold">{employer.country}</span>
                                    </td>
                                    <td className="align-middle">
                                      <button onClick={editCompany} className="fas fa-edit btn btn-link text-secondary mb-0" style={{ marginRight: "10px" }} value={employer.id}></button>
                                      <button onClick={deleteCompany} className="fa fa-trash btn btn-link text-secondary mb-0" value={employer.id}></button>
                                    </td>
                                  </tr>)
                              })}
                            </tbody>
