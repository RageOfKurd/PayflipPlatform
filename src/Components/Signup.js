                    ...
                    <div className="container">
                        <div className="row justify-content-center">
                            <div className="col-lg-5 text-center mx-auto">
                                <img alt="payfliplogo" height="70px" width="250px" src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fmiro.medium.com%2Fproxy%2F0*kYj1aQljmDquuw7Z&f=1&nofb=1" style={{ textAlign: 'center' }}></img>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div className="extrashadow">
                                    ...
                                    <div className="card-body">
                                        <form className="formtext" onSubmit={submitHandling}>
                                            ...
                                            <p hidden={true} id="existerror" style={{ color: "red", fontWeight: "bold", fontSize: "14px" }}>Account couldn't be created (email might already be registered). Try again later.</p>
