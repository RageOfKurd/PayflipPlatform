...
export const EmployeeBenefitsShoppingPage = () => {
    ...
    const urlavailablebenefits = "http://localhost:7000/employee-benefit/available"
    ...
    const addBenefit = (id) => {
        try {
            employeeBenefitsList.push(availableBenefitsList.find((benefit) => benefit.id == id.target.value));
                            ...
                            <div className="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
                                <ul className="navbar-nav">
                                    <li className="nav-item">
                                        <Link to="/employee/dashboard" className="hoverableitem nav-link" >
                                            <div
                                    ...
                                    <li className="nav-item">
                                        <Link to="/employee/benefits" className="hoverableitem nav-link active">
                                            <div
                                                className="icon icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                    ...
                                    <li className="nav-item">
                                        <Link to="/employee/mybenefits" className="hoverableitem nav-link">
                                            <div
                                                className="icon icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                                    ...
                                                    <MDBCol md={5}>
                                                        ...
                                                        >
                                                            ...
                                                            <MDBCardBody>
                                                                <MDBCardTitle>
                                                                    {benefit.name + " "}
                                                                    {<span style={{ fontSize: 15, color: "green" }}>{'€' + benefit.cost}</span>}
                                                                </MDBCardTitle>
