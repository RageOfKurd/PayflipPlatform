                            ...
                            <div className="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
                                <ul className="navbar-nav">
                                    <li className="nav-item">
                                        <Link to="/employee/dashboard" className="hoverableitem nav-link active" >
                                            <div
                                                    ...
                                                    <div className="col-8">
                                                        <div className="numbers">
                                                            ...
                                                            <h5 className="font-weight-bolder mb-0">
                                                                €{stats.data.total_spendable_amount}
                                                            </h5>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="row">
                                                    <div className="col-8">
                                                        <div className="numbers">
                                                            ...
                                                            <h5 className="font-weight-bolder mb-0">
                                                                {stats.data.total_benefits_ordered}
                                                            </h5>
                                                        </div>
                                                    </div>
                                                    <div className="col-4 text-end">
