...
export const EmployerAddBudgetPage = () => {
    ...
    const submitHandling = (data) => {
        data.preventDefault();
        axios.post(api_base_url + "/budget", {
            amount: amount,
                                    ...
                                    <div className="card z-index-0">
                                        <div className="extrashadow">
                                            <div className="card-header text-center pt-4">
                                                <h3 className="text-info">Add a Budget</h3>
                                            </div>
                                            <div className="card-body">
                                                <form className="formtext" onSubmit={submitHandling}>
                                                    ...
                                                    <div className="mb-3">
                                                        <input type="text" className="form-control" value={budget_type} onChange={(answer) => { setBudgetType(answer.target.value) }} placeholder="Budget Tye" aria-label="BudgetType" aria-describedby="email-addon" required />
                                                    </div>
                                                    <div className="mb-3">
                                                    ...
                                                    <p hidden="true" class="text-center" id="existerror" style={{ color: "red", fontWeight: "bold", fontSize: "14px" }}></p>
                                                    <div className="text-center">
                                                        <button type="submit" className="btn bg-redpayflip text-white w-100 my-4 mb-2">Add the Budget</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
