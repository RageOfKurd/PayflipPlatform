                ...
                <div className="backgroundimg">
                    ...
                    <main className="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
                            ...
                            <div className="container-fluid py-1 px-3">
                                <nav aria-label="breadcrumb">
                                    <ol className="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                                        <li className="breadcrumb-item text-sm"><a className="opacity-5 text-dark">Payflip</a></li>
                                        <li className="breadcrumb-item text-sm text-dark active" aria-current="page">Authorization</li>
                                    </ol>
                        ...
                        <div className="container-fluid py-4">
                            <div className="alert alert-primary" role="alert" style={{ color: 'white', width: '400px', margin: 'auto'}}>
                                <i className="fa fa-info-circle" aria-hidden="true"></i> We're redirecting you to the right page.
                            </div>
                            <img src="https://uploads-ssl.webflow.com/609269ab2583bd426a911d71/60c8c5a864a66c22e352f1dd_Homescreen%20start%20image.svg" width="800px" height="700px"></img>
